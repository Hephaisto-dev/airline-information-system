...
class FlightCreatorTest {
    ...
    static HashMap<String, AirportImpl> AirportHash = new HashMap<>();
    static AirportImpl port1 = AirportFactory.createAirportImpl("DUS");
    ...
    static AirplaneImpl plane1 = AirplaneFactory.createAirplaneImpl("Fly","me", 123);
    static AirplaneImpl plane2 = AirplaneFactory.createAirplaneImpl("Flighter","planeType",150);//needs to be faulty plane later
