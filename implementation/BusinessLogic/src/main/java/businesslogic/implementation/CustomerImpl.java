...
public class CustomerImpl implements Customer {
    ...
    @Override
    public String getId(){return customerData.id();}

    @Override
    public String getFirstName(){return customerData.firstName();}

    @Override
    public String getLastName(){return customerData.lastName();}

    @Override
    public LocalDate getDob(){return customerData.dob();}
