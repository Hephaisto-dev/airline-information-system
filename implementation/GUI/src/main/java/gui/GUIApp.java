...
public class GUIApp extends Application {
    ...
    private static final String INITIAL_VIEW = "CreateBookingView";
    ...
    private final Callback<Class<?>, Object> controllerFactory = (Class<?> c)
        ...
        case "gui.CreateBookingController" ->
                new CreateBookingController(this::getSceneManager, businessLogicAPI.getBookingManager(), businessLogicAPI.getFlightManager(), businessLogicAPI.getAirportManager());
